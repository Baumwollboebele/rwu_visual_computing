...
% calibrateCamera https://docs.opencv.org/4.x/d9/d0c/group__calib3d.html#ga3207604e4b1a1758aa66acb6ed5aa65d
...
\begin{figure}[H]
    ...
    \label{fig:binary}
\end{figure}
%The threshold value T(x,y) is a mean of the ������������������×������������������ neighborhood of (x,y) minus C
