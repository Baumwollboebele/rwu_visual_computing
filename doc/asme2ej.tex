...
\\
Lastly it is decided wheter a pixel will be mapped to 1 or 0 with application of \textbf{hysteresis.}\\\\
\noindent
...
In various tests, it has been found that an adaptive threshold\cite{opencv_adaptivethreshold} is best suited here.
Both an adaptive gaussian threshold\cite{pencv_adaptivetypes} and a adaptive mean threshold show great performance, 
though an adaptive gaussian threshold tends to generate noisier outputs.
...
\begin{figure}[H]
    \centerline{\includegraphics[width=2.5in]{output/hoch_3_9_binary_image.jpg}}
